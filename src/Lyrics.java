...
public class Lyrics {
    ...
    public static void main(String[] args) {
        ...
        //String firstLetter;
        for(int i=0;i<getWordsInLyrics().length;i++){
            String firstLetter = getWordsInLyrics()[i].substring(0,1);
            words = wordBegins.get(firstLetter);
            if(words == null){
                words = new LinkedList<>();
                wordBegins.put(firstLetter, words);
            }
            words.add(getWordsInLyrics()[i]);
        }
